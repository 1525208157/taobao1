...
<title>我的淘宝</title>
		...
		<!--我的淘宝图片--><link rel="apple-touch-icon" sizes="72x72" href="//img.alicdn.com/tps/i1/T11naSFbdaXXcCcBHm-72-72.png" />
		...
		<link rel="stylesheet" href="//g.alicdn.com/tb/mytaobao/5.1.4/pages/home/init.css" type="text/css" />
		...
		<script type="text/javascript" src="//g.alicdn.com/tb/??mytaobao/5.1.4/components/common/package-config.js,mytaobao/5.1.4/deps.js"></script>
		...
		<header class="mt-header" data-spm="a210b">
			<article>
				<div class="mt-logo" style="margin-left: 0px;">
					<a title="我的淘宝" href="//i.taobao.com/my_taobao.htm?nekot=1470211439696&amp;tracelog=newmytb_logodianji" class="mt-tblogo" data-spm="d1000351"></a>
				</div>
				<nav class="mt-nav">
					<ul id="J_MtMainNav">
						<li class="selected">
								...
								<div class="search-panel-fields">
									...
									<div class="search-combobox" id="ks-component1045">
										<div class="search-combobox-input-wrap">
											<input id="q" name="q" accesskey="s" autofocus="true" autocomplete="off" x-webkit-speech="" x-webkit-grammar="builtin:translate" aria-haspopup="true" aria-combobox="list" role="combobox" class="search-combobox-input" aria-label="请输入搜索文字或从搜索历史中选择"></div>
									</div>
								</div>
					...
					<div class="main-wrap">
							...
							<div class="mt-ml-shim">
								...
								<div class="m-userinfo" data-spm="972272805">
									<div class="s-userbar s-bar" style="padding-top: 10px;">
										<div class="s-baseinfo">
											<div target="_blank" class="s-avatar" data-spm="d4911997">
												<img src="//wwc.alicdn.com/avatar/getAvatar.do?userId=2116339787&amp;width=160&amp;height=160&amp;type=sns">
											</div>
											<div class="s-name">
									...
									<div class="s-my-counts s-content">
										<ul>
											<li>
												<a data-spm="d4919660" target="_blank" href="//buyertrade.taobao.com/trade/itemlist/list_bought_items.htm?action=itemlist/BoughtQueryAction&event_submit_do_query=1&tabCode=waitPay"><span>待付款</span></a>
											</li>
											<li>
												<a data-spm="d4919661" target="_blank" href="//buyertrade.taobao.com/trade/itemlist/list_bought_items.htm?action=itemlist/BoughtQueryAction&event_submit_do_query=1&tabCode=waitSend"><span>待发货</span></a>
											</li>
											<li>
												<a data-spm="d4919662" target="_blank" href="//buyertrade.taobao.com/trade/itemlist/list_bought_items.htm?action=itemlist/BoughtQueryAction&event_submit_do_query=1&tabCode=waitConfirm"><span>待收货<em>2</em></span></a>
											</li>
											<li>
												<a data-spm="d4919663" target="_blank" href="//buyertrade.taobao.com/trade/itemlist/list_bought_items.htm?action=itemlist/BoughtQueryAction&event_submit_do_query=1&tabCode=waitRate"><span>待评价<em>1</em></span></a>
											</li>
											<li>
												<a data-spm="d4919664" target="_blank" href="//refund.taobao.com/refund_list.htm"><span>退款</a></span>
											</li>
										</ul>
									</div>
								</div>
								...
								<div data-spm="1998049142" class="m-logistics g-box-base g-mb-set">
									...
									<div class="s-content">
										<ul class="lg-list">
											...
											<li class="lg-item">
												<div class="item-info">
													<a data-spm="d4919535" target="_blank" href="//buyertrade.taobao.com/trade/detail/trade_item_detail.htm?bizOrderId=139307624846338797&tracelog=yimaidaopic">
														<img src="//img.alicdn.com/bao/uploaded/i3/2176952686/TB2cB5ToB4lpuFjy1zjXXcAKpXa_!!2176952686.jpg_120x120xz.jpg" alt="南极人皮肤衣男女户外超薄防晒服情侣款春夏季透气运动风衣防晒衣" />
													</a>
												...
												<div class="lg-confirm">
													<a data-spm="d4919529" target="_blank" class="i-btn-typical" href="//buyertrade.taobao.com/trade/confirm_goods.htm?biz_order_id=139307624846338797&tracelog=yimaidaocheck">确认收货</a>
												</div>
											</li>
						...
						<div class="mt-ml-toolbar J_MTToolBar">
							<div class="s-tool-tab">
								<a class="s-tool-btn J_ToolBtn" data-for=".J_Calendar,.J_SUniverse" href="#"><i class="s-tool-icon">&#xe636;</i><br/>我<br/>的<br/>日<br/>历<br/><i class="s-tool-count">2</i></a>
							</div>
						</div>
						<div class="mt-ml-c2">
							...
							<div data-spm="1998056009" class="g-box-base m-calendar J_Calendar i-toobar-con">
								...
								<div class="s-content">
									...
									<a href="">
										<img border="0" src="https://img.alicdn.com/simba/img/TB1FPLqX1ySBuNjy1zdSutPxFXa.jpg" width="300px" height="125px">
									</a>
									<a href="">
										<img border="0" src="https://img.alicdn.com/simba/img/TB1FPLqX1ySBuNjy1zdSutPxFXa.jpg" width="300px" height="125px">
									</a>
					...
					<aside class="mt-menu" id="J_MtSideMenu">
						<div class="mt-menu-tree">
							<dl class="mt-menu-item" data-spm="a2109">
								...
								<dd>
									<a href="//cart.taobao.com/cart.htm?nekot=1470211439694" target="_blank" role="menuitem" data-spm="d1000367">我的购物车</a>
								</dd>
				...
				<div class="modal-body">
					<div class="row">
						<div id="visDiv" class="col-lg-6 col-sm-6">
							<br><br>
							<div class="row">
								<div class="col-lg-3 col-sm-3" style="text-align: right"><font size="4" style="font-family: SimHei;">账号:</font></div>
								<div class="col-lg-9 col-sm-9">
									<input type="text" id="account" style="width: 90%;height: 28px" onchange="isNull()">
								</div>
							</div>
							<br><br>
							<div class="row">
							...
							<div style="text-align: center">
								<button type="button" id="nextBtn" onclick="validationUser()" class="btn btn-default">下一步</button>
							</div>
						</div>
						<div id="hidDiv" class="col-lg-6 col-sm-6" style="visibility: hidden;">
							<br><br>
							<div class="row">
